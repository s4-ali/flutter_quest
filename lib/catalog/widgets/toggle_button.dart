  ...
  Widget build(BuildContext context) {
    ...
    return PropertyExplorerBuilder(
      ...
      builder: (provider) {
        ...
        final textStyle =
            provider.textStyleField(id: "textStyle", title: "textStyle");
        ...
        final selectedColor =
            provider.colorField(id: "selectedColor", title: "selectedColor");
        final disabledColor =
            provider.colorField(id: "disabledColor", title: "disabledColor");
        final fillColor =
            provider.colorField(id: "fillColor", title: "fillColor");
        final focusColor =
            provider.colorField(id: "focusColor", title: "focusColor");
        final highlightColor =
            provider.colorField(id: "highlightColor", title: "highlightColor");
        final hoverColor =
            provider.colorField(id: "hoverColor", title: "hoverColor");
        final splashColor =
            provider.colorField(id: "splashColor", title: "splashColor");
        final renderBorder =
            provider.booleanField(id: "renderBorder", title: "renderBorder");
        final selectedBorderColor = provider.colorField(
            id: "selectedBorderColor", title: "selectedBorderColor");
        final disabledBorderColor = provider.colorField(
            id: "disabledBorderColor", title: "disabledBorderColor");
        final borderRadius = provider.borderRadiusField(
            id: "borderRadius", title: "borderRadius");
        final borderWidth =
            provider.doubleField(id: "borderWidth", title: "borderWidth");
        final borderColor =
            provider.colorField(id: "borderColor", title: "borderColor");
        final direction =
            provider.axisField(id: "direction", title: "direction");
        final verticalDirection = provider.verticalDirectionField(
            id: "verticalDirection", title: "verticalDirection");
        ...
        return (
          ...
          code: "ToggleButton code goes here",
        );
      },
    );
  }
