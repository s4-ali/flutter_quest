...
class _ExpandableMenuState extends State<ExpandableMenu>
  ...
  void initState() {
    ...
    _containerAnimationController = AnimationController(
      duration: Duration(milliseconds: widget.items.length * 60 + 250),
      vsync: this,
    );
  ...
  Widget build(BuildContext context) {
    print("ExpandableMenu: build");
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        final maxWidth = constraints.maxWidth;
        final contentWidth = (widget.width * .15) +
            widget.width +
            (itemSize + 2) * widget.items.length;
        final width = contentWidth > maxWidth ? maxWidth : contentWidth;
        return SizedBox(
          width: width,
          child: Row(
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ExpandableIcon(
                      ...
                      onClicked: onExpandableIconClicked,
                    ),
                    Expanded(
                      child: SizedBox(
                        // width: _containerProgress < 0.6
                        //     ? 0
  ...
  double get itemSize => widget.height * .90;
}
