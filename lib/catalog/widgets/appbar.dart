  ...
  Widget build(BuildContext context) {
    return PropertyExplorerBuilder(
      ...
      builder: (provider) {
        ...
        final title = provider.stringField(id: "title", title: "Title Widget");
        final action =
        ...
        final iconSize =
            provider.doubleField(id: "iconSize", title: "IconTheme Size");
        final iconFill =
            provider.doubleField(id: "iconFill", title: "IconTheme Fill");
        final iconWeight =
            provider.doubleField(id: "iconWeight", title: "IconTheme Weight");
        final iconGrade =
            provider.doubleField(id: "iconGrade", title: "IconTheme Grade");
        final iconOpticalSize = provider.doubleField(
            id: "iconOpticalSize", title: "IconTheme Optical Size");
        final iconColor =
            provider.colorField(id: "iconColor", title: "IconTheme Color");
        ...
        final centerTitle =
            provider.booleanField(id: "centerTitle", title: "Center Title");
        final excludeHeaderSemantics = provider.booleanField(
            id: " excludeHeaderSemantics", title: " Exclude Header Semantics");
        final titleSpacing =
            provider.doubleField(id: "titleSpacing", title: "Title Spacing");
        ...
        final toolbarHeight =
            provider.doubleField(id: "toolbarHeight", title: "Toolbar Height");
        final leadingWidth =
            provider.doubleField(id: "leadingWidth", title: "Leading Width");
        ...
        final statusBarColor = provider.colorField(
            id: "statusBarColor", title: "Status Bar Color");
