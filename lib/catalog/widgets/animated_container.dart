  ...
  Widget build(BuildContext context) {
    return PropertyExplorerBuilder(
      ...
      builder: (provider) {
        ...
        final fgShadowColor =
        provider.colorField(id: "shadowColor", title: "Foreground Shadow Color");
        final fgScaleX = provider.doubleField(id: "scaleX", title: "Foreground ScaleX");
        final fgScaleY = provider.doubleField(id: "scaleY", title: "Foreground ScaleY");
        ...
        final fgBlurStyle = provider.listField(
            id: "blurStyle", title: "Foreground Blur Style", values: BlurStyle.values);
