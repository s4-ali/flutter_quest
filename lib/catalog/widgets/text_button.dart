  ...
  Widget build(BuildContext context) {
    return PropertyExplorerBuilder(
      ...
      builder: (provider) {
        ...
        final text = provider.stringField(id: "text", title: "Text of Child");
        final isSemanticButton = provider.booleanField(
            id: "isSemanticButton", title: "isSemantic Button");
        ...
        return (
          widget: TextButton(
            ...
            isSemanticButton: isSemanticButton ?? true,
            child: Text(
              text ?? '',
            ),
          ),
          code: "TextButton goes here...",
        );
      },
    );
  }
