...
class IconButtonPropertyExplorer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PropertyExplorerBuilder(
      ...
      builder: (provider) {
        final iconSize =
            provider.doubleField(id: "iconSize", title: "Icon Size");
        ...
        final highlightColor =
            provider.colorField(id: "highlightColor", title: "Highlight Color");
        final splashColor =
            provider.colorField(id: "splashColor", title: "Splash Color");
        final disabledColor =
            provider.colorField(id: "disabledColor", title: "Disabled Color");
        ...
        final strokeAlign = provider
            .listField(id: "strokeAlign", title: "Stroke Align", values: [
          BorderSide.strokeAlignCenter,
          BorderSide.strokeAlignInside,
          BorderSide.strokeAlignOutside,
        ]);
        final styleMouseCursor = provider.listField(
            id: "mouseCursor",
            title: "mouseCursor",
        ...
        final styleEnableFeedback = provider.booleanField(
            id: "enableFeedback", title: "enable Feedback");
        final styleAlignment =
            provider.alignmentField(id: "alignment", title: "Alignment");
        final textStyle =
            provider.textStyleField(id: "textStyle", title: "Text Style");

        final isSelected =
            provider.booleanField(id: "isSelected", title: "Is Selected");
        final selectedIcon =
            provider.iconDataField(id: "selectedIcon", title: "Selected Icon");
        ...
        return (
          widget: IconButton(
            ...
            style: ButtonStyle(
              ...
              maximumSize: MaterialStatePropertyAll<Size>(
                Size(styleMaxWidth ?? double.infinity,
                    styleMaxHeight ?? double.infinity),
              ),
          ...
          code: "IconButton code goes here...",
        );
      },
    );
  }
