  ...
  Widget build(BuildContext context) {
    return PropertyExplorerBuilder(
      ...
      builder: (provider) {
        ...
        final cacheWidth = provider.intField(id: "cacheWidth", title: "Cache Width");
        final cacheHeight = provider.intField(id: "cacheHeight", title: "Cache Height");


        return Image.network(
               image?? "https://usabilitygeek.com/wp-content/uploads/2018/06/mobile-usability-testing-lead.jpg",
          height: height,
          width: width,
          scale: scale?? 1.0,
