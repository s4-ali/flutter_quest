...
typedef IconButtonProperties = ({
  double? iconSize,
  List<VisualDensity>? visualDensity,
  IconData? icon,
  EdgeInsets? padding,
  Alignment? alignment,
  double? splashRadius,
  ...
  List<MouseCursor>? styleMouseCursor,
  List<VisualDensity>? styleVisualDensity,
  List<MaterialTapTargetSize>? tapTargetSize,
