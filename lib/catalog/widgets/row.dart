...
class RowPropertyExplorer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PropertyExplorerBuilder(
      widgetName: "Row",
      builder: (provider) {
        final mainAxisAlignment = provider.mainAxisAlignmentField(
            id: "mainAxisAlignment", title: "Main Axis Alignment");
        final mainAxisSize = provider.mainAxisSizeField(
            id: "mainAxisSize", title: "Main Axis Size");
        final crossAxisAlignment = provider.crossAxisAlignmentField(
        ...
        final textBaseLine = provider.listField<TextBaseline>(
            id: "textBaseLine",
            title: "TextBaseLine",
