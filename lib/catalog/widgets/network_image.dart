  ...
  Widget build(BuildContext context) {
    return PropertyExplorerBuilder(
      ...
      builder: (provider) {
        ...
        final scale = provider.doubleField(id: "scale", title: "scale");
        final image = provider.stringField(id: "image", title: "Image Link");
        final semanticLabel =
            provider.stringField(id: "semanticLabel", title: "semanticLabel");
        ...
        final colorBlendMode = provider.listField(
            id: "colorBlendMode",
            title: "colorBlendMode",
            values: BlendMode.values);
        final fit =
            provider.listField(id: "fit", title: "Fit", values: BoxFit.values);
        final alignment =
        ...
        final centerSlice = provider.listField(
            id: "centerSlice",
            title: "Center Slice",
        ...
        final isAntiAlias =
            provider.booleanField(id: "isAntiAlias", title: "isAntiAlias");
        final filterQuality = provider.listField(
            id: "filterQuality",
            title: "filterQuality",
            values: FilterQuality.values);
        final cacheWidth =
            provider.intField(id: "cacheWidth", title: "Cache Width");
        final cacheHeight =
            provider.intField(id: "cacheHeight", title: "Cache Height");
        ...
        return (
          ...
          code: "Network Image code goes here...",
        );
      },
    );
  }
